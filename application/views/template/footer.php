      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            ...
            </script> Elizabeth-Zion Asia Pacific Pte Ltd. All Rights Reserved. Singapore Co. Reg.No 201207152E
          </div>
        </div>
      </div>
    </footer>
    ...
    <!--   Optional JS   -->
    <script src="<?= base_url() ?>assets/v2/js/plugins/chart.js/dist/Chart.min.js"></script>
    <script src="<?= base_url() ?>assets/v2/js/plugins/chart.js/dist/Chart.extension.js"></script>
    <!--   Argon JS   -->
