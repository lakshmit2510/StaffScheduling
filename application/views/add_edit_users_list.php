                                    ...
                                    if ($Users != 0) {
                                        ...
                                        foreach ($Users as $row) {
                                            ...
                                            echo '<tr>
                                                ...
                                                <td>
                                                <a href="javascript:void(0);" data-toggle="modal" data-target="#employeeView' . $row->UserUID . '" data-userId="' . $row->UserUID . '" class="btn btn-space btn-info view-btn"><i class="icon icon-left mdi mdi-eye"></i> View</a>
                                                <a href="' . base_url('Users/edit/' . $row->UserUID) . '" class="btn btn-space btn-warning"><i class="icon icon-left mdi mdi-edit"></i> Edit</a>
                                                </td>
                                                </tr>
                                                <div id="employeeView' . $row->UserUID . '" tabindex="-1" role="dialog" class="modal colored-header colored-header-primary fade">
