          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default">
                <h1 class="panel-heading panel-heading-divider my-3">Print View  <span class="float-right"><a href="javascript:history.go(-1)" class="btn btn-space btn-danger"><i class="fa fa-arrow-left"></i> Back to list</a> <a id="printagain" class="btn btn-md text-white btn-space btn-primary"><i class="fa fa-print"></i> Print again</a></span></h1>
                <hr/>
