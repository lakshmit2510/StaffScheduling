                                ...
                                if ($Projects != 0) {
                                    ...
                                    foreach ($Projects as $row) {
                                        echo '<tr>
                                            ...
                                            <td>' . $row->Location . '</td>
                                            <td>' . $row->ProjectSupervisor . '</td>
                                            <td>' . $row->ProjectManager . '</td>'; ?>
                                        <td><a href="<?php echo base_url('Projects/') ?>edit/<?php echo $row->ProjectCode ?>" class="btn btn-space btn-warning">Edit</a>
                                            <a href="<?php echo base_url('Projects/') ?>delete/<?php echo $row->ProjectCode ?>" onclick="return confirm('Are you sure to delete')" class="btn btn-space btn-danger">Delete</a></td>
                                <?php
                                    }
                                }
                                ?>
