                      ...
                      <tbody>
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  font-size: 14px; margin: 0;">
                          <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                            <?php $book = $this->Booking_model->getBookingDetailsByRefNo($RefNo, 'RefNo'); ?>
                              ...
                              <div class="col-sm-6">
                                ...
                                <table class="table">
                                  <tr>
                                    <td><b>Date</b></td>
                                    <td width="20"><b>:</b></td>
                                    <td><?php echo date('m/d/Y', strtotime($book->StartDate)); ?></td>
                                  </tr>
                                  <tr>
                                    <td><b>Shift Start Time</b></td>
                                    <td width="20"><b>:</b></td>
                                    <td><?php echo $book->ShiftStartTime ?></td>
                                  </tr>
                                  <tr>
                                    <td><b>Shift End Time</b></td>
                                    <td width="20"><b>:</b></td>
                                    <td><?php echo $book->ShiftEndTime ?></td>
                                  </tr>
                                  <p>Please Report to the Supervisor <strong>Chee Chin</strong></p>
                                </table>
                              </div>
                            </div>
                          </td>
