...
<head>
  ...
  <style>
    body {
      background: url('../assets/img/pic2.jpg') no-repeat center center fixed;
                ...
                <form action="<?php echo base_url('Login/save'); ?>" class="form-horizontal" method="post">
                  ...
                  <div class="form-group row">
                    <div class="col-xs-6" style="margin-left: 100px;">
                      <a href="<?php echo base_url(); ?>" class="btn btn-outline-info btn-lg">Cancel</a>
                    </div>
                  </div>
                </form>
                <hr>
                <div class="splash-footer">
                  <p><strong>&copy; 2019 Elizabeth-Zion Asia Pacific Pte Ltd. All Rights Reserved. Singapore Co. Reg.No 201207152E</strong></p>
                </div>
              </div>
