            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary be-loading">
                ...
                <div class="panel-body">
                  ...
                  <form action="<?php echo base_url('Supplier/Groups/post');?>" class="form-horizontal" method="post">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Group Name</label>
                      <div class="col-sm-6">
                        <input type="text" name="groupname" placeholder="Supplier Group Name" class="form-control" required>
                      </div>
                    </div>
                        ...
                        <div class="row">
                          <?php
                            for ($zi=0; $zi < 24; $zi++) { 
                              ...
                              echo "<div class='col-sm-2'><label class='time-slot' for='time{$zi}'> <input type='checkbox' name='slots[]' id='time{$zi}' value='{$zi}'/>  <small><i class='fa fa-check'></i> {$zil}:30 - {$zir}:30</small></label></div>";
                            };
                          ?>
                       </div>
                      </div>
