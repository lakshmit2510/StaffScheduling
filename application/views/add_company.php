    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary be-loading">
          <h1 class="panel-heading panel-heading-divider my-3"><i class="icon mdi mdi-layers"></i> Add New Company</h1>
          <hr />
          <div class="panel-body">
            <form action="<?php echo base_url('Company/add'); ?>" class="form-horizontal" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" required="" placeholder="Website Name" name="WebsiteName" class="form-control">
                </div>
              </div>
              <div class="form-group">
